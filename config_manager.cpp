...
bool ConfigManager::Load(string FileName, vector<Record>& content)
{
...
bool ConfigManager::Save(string FileName, vector<Record>& content)
{
...
string ConfigManager::Content(string FileName)
{
...
vector<string> ConfigManager::GetSectionNames(string FileName)
{
...
vector<ConfigManager::Record> ConfigManager::GetSection(string SectionName, string FileName)
{
...
bool ConfigManager::RecordExists(string KeyName, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
    ...
    if (Load(FileName, content))                                            // Make sure the file is loaded
    {
        vector<Record>::iterator iter = std::find_if(content.begin(), 
                content.end(), 
                ConfigManager::RecordSectionKeyIs(SectionName,KeyName));         // Locate the Section/Key
...
bool ConfigManager::SectionExists(string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
    ...
    if (Load(FileName, content))                                            // Make sure the file is loaded
    {
        vector<Record>::iterator iter = std::find_if(content.begin(), 
                content.end(), 
                ConfigManager::RecordSectionIs(SectionName));                    // Locate the Section
...
vector<ConfigManager::Record> ConfigManager::GetRecord(string KeyName, string SectionName, string FileName)
{
    vector<Record> data;                                                  // Holds the return data
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
    ...
    if (Load(FileName, content))                                            // Make sure the file is loaded
    {
        vector<Record>::iterator iter = std::find_if(content.begin(), 
                content.end(), 
                ConfigManager::RecordSectionKeyIs(SectionName,KeyName));         // Locate the Record
...
string ConfigManager::GetValue(string KeyName, string SectionName, string FileName)
{
...
bool ConfigManager::SetValue(string KeyName, string Value, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::RenameSection(string OldSectionName, string NewSectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::CommentRecord(CommentChar cc, string KeyName,string SectionName,string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::UnCommentRecord(string KeyName,string SectionName,string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::CommentSection(char CommentChar, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::UnCommentSection(string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::DeleteRecord(string KeyName, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::DeleteSection(string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::SetSectionComments(string Comments, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::SetRecordComments(string Comments, string KeyName, string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
vector<ConfigManager::Record> ConfigManager::GetSections(string FileName)
{
    vector<Record> data;                                                  // Holds the return data
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::Sort(string FileName, bool Descending)
{
    vector<ConfigManager::Record> content;                                     // Used to hold the sorted content
    vector<ConfigManager::Record> sections = GetSections(FileName);                // Get a list of Sections
    ...
    if(!sections.empty())                                                   // Is there anything to process?
    {
        ...
        {                                                                       
            ...
            vector<ConfigManager::Record> records = GetSection(iter->Section ,FileName); // Get a list of Records for this section
...
bool ConfigManager::AddSection(string SectionName, string FileName)
{
    vector<Record> content;                                                   // Holds the current record                                                 // Holds the current record
...
bool ConfigManager::Create(string FileName)
{
